/** Cburnett-style filled chess pieces — identical geometry for white and black. */
...
export function ChessPieceSvg({
  ...
  const stroke = white ? '#2a1c12' : '#cfc3b0'
  const detail = white ? '#2a1c12' : '#cfc3b0'
    ...
    <svg className={className} viewBox="0 0 45 45" aria-hidden>
      ...
      {kind === 'N' && (
        <g fill="none" fillRule="evenodd" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}>
          ...
          />
          <path fill={detail} stroke="none" d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0m5.433-9.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5" />
        </g>
      )}
      ...
      {kind === 'B' && (
        <g fill="none" fillRule="evenodd" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}>
          ...
          <path stroke={detail} strokeLinejoin="miter" d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" />
        </g>
      )}
